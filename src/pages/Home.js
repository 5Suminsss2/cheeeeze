...
// const target = ['전체', 'Music', 'Comedy', 'Entertainment'];
...
//         if (filter==="전체" || data.category.includes(filter)) return true;
//         return false;
//     }
...
//                     {youtubeData['data'].filter(filterVideo).map(HomeCard)}
//                 </div>
//             </div>
//         </Layout>
//     )
